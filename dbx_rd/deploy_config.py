...
Standalone copy for dbx_rd/ prototyping. The canonical version lives at
retail_agent/src/deploy_config.py. This copy exists so the adapter classes
can be uploaded and run on the cluster without dependencies outside dbx_rd/.
