...
Consider a retail assistant chatbot. A customer asks about a shoe they bought, and a traditional RAG system would retrieve the closest-matching product description:
...
The retail assistant's knowledge graph has three tiers of nodes and relationships:
