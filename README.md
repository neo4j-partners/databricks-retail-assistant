...
The `backend/` directory contains a standalone FastAPI server that runs the same LangChain agent locally, useful for development and testing without a Databricks workspace.
